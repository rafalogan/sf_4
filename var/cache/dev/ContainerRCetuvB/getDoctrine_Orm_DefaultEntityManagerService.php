...
$a->setNamespace('sf_orm_default_1d9a339a05813d575565c36c28d6d99d15216f76b7ae5d788f41dadf558063c7');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_1d9a339a05813d575565c36c28d6d99d15216f76b7ae5d788f41dadf558063c7');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_1d9a339a05813d575565c36c28d6d99d15216f76b7ae5d788f41dadf558063c7');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\AlunoRepository' => function () {
    return ($this->privates['App\Repository\AlunoRepository'] ?? $this->load(__DIR__.'/getAlunoRepositoryService.php'));
}, 'App\\Repository\\BannerRepository' => function () {
    return ($this->privates['App\Repository\BannerRepository'] ?? $this->load(__DIR__.'/getBannerRepositoryService.php'));
}, 'App\\Repository\\ContentRepository' => function () {
    return ($this->privates['App\Repository\ContentRepository'] ?? $this->load(__DIR__.'/getContentRepositoryService.php'));
}, 'App\\Repository\\ImageRepository' => function () {
    return ($this->privates['App\Repository\ImageRepository'] ?? $this->load(__DIR__.'/getImageRepositoryService.php'));
}, 'App\\Repository\\MenuRepository' => function () {
    return ($this->privates['App\Repository\MenuRepository'] ?? $this->load(__DIR__.'/getMenuRepositoryService.php'));
}, 'App\\Repository\\NewsLetterRepository' => function () {
    return ($this->privates['App\Repository\NewsLetterRepository'] ?? $this->load(__DIR__.'/getNewsLetterRepositoryService.php'));
}, 'App\\Repository\\PageRepository' => function () {
    return ($this->privates['App\Repository\PageRepository'] ?? $this->load(__DIR__.'/getPageRepositoryService.php'));
}, 'App\\Repository\\TextRepository' => function () {
    return ($this->privates['App\Repository\TextRepository'] ?? $this->load(__DIR__.'/getTextRepositoryService.php'));
}, 'App\\Repository\\UrlRepository' => function () {
    return ($this->privates['App\Repository\UrlRepository'] ?? $this->load(__DIR__.'/getUrlRepositoryService.php'));
}, 'App\\Repository\\UsersRepository' => function () {
    return ($this->privates['App\Repository\UsersRepository'] ?? $this->load(__DIR__.'/getUsersRepositoryService.php'));
}))));
