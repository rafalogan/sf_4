...
// Returns the private 'App\Repository\TextRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TextRepository.php';

return $this->privates['App\Repository\TextRepository'] = new \App\Repository\TextRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
