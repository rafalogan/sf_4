...
// Returns the private 'App\Repository\AlunoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AlunoRepository.php';

return $this->privates['App\Repository\AlunoRepository'] = new \App\Repository\AlunoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
